...
import (
	...
	"github.com/fullstack-lang/gongtone"
...
func ServeStaticFiles(logGINFlag bool) (r *gin.Engine) {
	...
	r.Use(static.Serve("/", EmbedFolder(gongtone.NgDistNg, "ng-github.com-fullstack-lang-gongtone/dist/ng-github.com-fullstack-lang-gongtone/browser")))
